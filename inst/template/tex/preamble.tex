...
\titlespacing*{\chapter}{0pt}{0pt}{0.3\baselineskip}
...
% Jarak judul sesuai pedoman hlm. 34 (relatif thd jarak baris teks = 2 spasi):
%   bab->sub bab 4 spasi, bab/sub bab->teks 3 spasi. Nilai dikalibrasi via
%   pengukuran piksel render (body baseline 50px@150dpi): hasil ~3,0-3,7 spasi,
%   bab->sub bab terbesar. titlesec menjumlah afterskip bab + beforeskip sub bab
%   sehingga bab->sub bab otomatis > transisi lain.
\titlespacing*{\section}{0pt}{0.38\baselineskip}{0.42\baselineskip}
\titlespacing*{\subsection}{0pt}{0.38\baselineskip}{0.42\baselineskip}
\titlespacing*{\subsubsection}{0pt}{0.38\baselineskip}{0.42\baselineskip}
...
\titleformat{name=\chapter,numberless}[display]
  ...
  {}{0pt}
  {\MakeUppercase}
\titlespacing*{name=\chapter,numberless}{0pt}{0pt}{0.3\baselineskip}
...
\setlength{\cftbeforelottitleskip}{2\baselineskip}\setlength{\cftafterlottitleskip}{1.5\baselineskip}
\setlength{\cftbeforeloftitleskip}{2\baselineskip}\setlength{\cftafterloftitleskip}{1.5\baselineskip}
